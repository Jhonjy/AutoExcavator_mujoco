...
execute_process(
  COMMAND "/usr/bin/git" show-ref "c2435f8342c2d0ed8101cb43adfd605fdc52dca2"
  WORKING_DIRECTORY "/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/abseil-cpp-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "c2435f8342c2d0ed8101cb43adfd605fdc52dca2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("c2435f8342c2d0ed8101cb43adfd605fdc52dca2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/c2435f8342c2d0ed8101cb43adfd605fdc52dca2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/abseil-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/abseil-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
