...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2dd015dfef425c866d9a43f2c67d8b52d709acb6"
  WORKING_DIRECTORY "/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/benchmark-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "2dd015dfef425c866d9a43f2c67d8b52d709acb6")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("2dd015dfef425c866d9a43f2c67d8b52d709acb6" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/2dd015dfef425c866d9a43f2c67d8b52d709acb6")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/benchmark-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu2204/mujoco_develop/excavator_simulator_mujoco/build/_deps/benchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
